...
namespace AuthorizeNet_Payments
{
    ...
    {
        public static Tuple<ANetApiResponse, createTransactionController> Run(string ApiLoginID, string ApiTransactionKey, decimal TransactionAmount, string TransactionID, Environment env, CreditCardInfo cardInfo)
        {
